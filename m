...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 212DD1A42E3
	for <lists+linux-mediatek@lfdr.de>; Fri, 10 Apr 2020 09:18:11 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=bXTXlEeMjBb7sHcEzFFpIf1GVQe0n/gvUaS54Uh9RDc=; b=o9h3MUzpAku48H
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jMnvE-00046q-4e; Fri, 10 Apr 2020 07:17:52 +0000
Received: from mailgw02.mediatek.com ([216.200.240.185])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jMnv8-000469-Eh; Fri, 10 Apr 2020 07:17:50 +0000
X-UUID: 625abcff3304488d81dc32cb9b638e60-20200409
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com;
 s=dk; 
 h=Content-Transfer-Encoding:Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From;
 bh=AI3/ia96H973yV1i0qYDqMNUBD3nalrbH1SjdRdp9wc=; 
...
Received: from mtkcas68.mediatek.inc [(172.29.94.19)] by mailgw02.mediatek.com
 ...
 with ESMTP id 243586479; Thu, 09 Apr 2020 23:17:34 -0800
...
To: <hans.verkuil@cisco.com>, <laurent.pinchart+renesas@ideasonboard.com>,
 ...
 <mchehab@kernel.org>
Subject: [RFC PATCH V6 1/3] media: platform: mtk-isp: Add Mediatek sensor
 interface driver
...
MIME-Version: 1.0
X-MTK: N
X-Spam-Note: CRM114 run bypassed due to message size (306126 bytes)
X-Spam-Score: -0.2 (/)
...
index d13db96e3015..e80e6538b0c7 100644
--- a/drivers/media/platform/Makefile
+++ b/drivers/media/platform/Makefile
@@ -90,6 +90,7 @@ obj-$(CONFIG_VIDEO_MEDIATEK_MDP)	+= mtk-mdp/
...
diff --git a/drivers/media/platform/mtk-isp/seninf/TODO b/drivers/media/platform/mtk-isp/seninf/TODO
new file mode 100644
index 000000000000..291354e0d62d
--- /dev/null
+++ b/drivers/media/platform/mtk-isp/seninf/TODO
@@ -0,0 +1,18 @@
+* Add necessary depends in Kconfig
+* use objs method in Makefile
...
+* Fix coding style
+* Refine error handling and return value
