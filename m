...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 324A5B59C0
	for <lists+linux-mediatek@lfdr.de>; Wed, 18 Sep 2019 04:39:38 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=dNwJuL1MfvYZiL6nxOinuSn1sB9dB7GDbl+160BV5WU=; b=uQKoTyrMBJZfRd
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.2 #3 (Red Hat Linux))
	id 1iAPsT-0003P3-HZ; Wed, 18 Sep 2019 02:39:33 +0000
Received: from mailgw02.mediatek.com ([216.200.240.185])
 by bombadil.infradead.org with esmtps (Exim 4.92.2 #3 (Red Hat Linux))
 id 1iAPsO-0003IS-PI
 for linux-mediatek@lists.infradead.org; Wed, 18 Sep 2019 02:39:30 +0000
X-UUID: daa04a5ab128468ea9ad00968659722e-20190917
X-UUID: daa04a5ab128468ea9ad00968659722e-20190917
Received: from mtkcas67.mediatek.inc [(172.29.193.45)] by mailgw02.mediatek.com
 (envelope-from <light.hsieh@mediatek.com>)
 (musrelay.mediatek.com ESMTP with TLS)
 with ESMTP id 368497337; Tue, 17 Sep 2019 18:39:16 -0800
Received: from mtkmbs08n2.mediatek.inc (172.21.101.56) by
 MTKMBS62DR.mediatek.inc (172.29.94.18) with Microsoft SMTP Server (TLS) id
 15.0.1395.4; Tue, 17 Sep 2019 19:39:16 -0700
...
Subject: [PATCH v5 3/5] pinctrl: mediatek: Refine mtk_pinconf_get() and
 mtk_pinconf_set()
Date: Wed, 18 Sep 2019 10:39:06 +0800
Message-ID: <1568774348-24363-3-git-send-email-light.hsieh@mediatek.com>
...
MIME-Version: 1.0
X-TM-SNTS-SMTP: 6072E1B6A7F33AFB4456D6CE4D5480ECC7C84CA883F4C2FC98DF824AB776670E2000:8
X-MTK: N
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20190917_193928_827748_7193C918 
...
@@ -210,60 +188,45 @@ static int mtk_pinconf_set(struct pinctrl_dev *pctldev, unsigned int pin,
...
+		err = mtk_hw_set_value(hw, desc, PINCTRL_PIN_REG_SR, !!arg);
 	...
 	case PIN_CONFIG_OUTPUT:
 		err = mtk_hw_set_value(hw, desc, PINCTRL_PIN_REG_DIR,
@@ -273,41 +236,29 @@ static int mtk_pinconf_set(struct pinctrl_dev *pctldev, unsigned int pin,
...
-			goto err;
 	...
 	case MTK_PIN_CONFIG_PU_ADV:
 	case MTK_PIN_CONFIG_PD_ADV:
@@ -317,20 +268,14 @@ static int mtk_pinconf_set(struct pinctrl_dev *pctldev, unsigned int pin,
 			pullup = param == MTK_PIN_CONFIG_PU_ADV;
...
+			err = -ENOTSUPP;
 	...
 	default:
 		err = -ENOTSUPP;
@@ -946,6 +891,7 @@ int mtk_paris_pinctrl_probe(struct platform_device *pdev,
 	return 0;
 }
...
@@ -964,4 +910,3 @@ static int mtk_paris_pinctrl_resume(struct device *device)
