...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BAA320030D
	for <lists+linux-mediatek@lfdr.de>; Fri, 19 Jun 2020 09:55:07 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=NiHHv56Vq89ETm4/FKYH0QpGQ7y+wZPCBTFh3rSLLn4=; b=drDibaxw1Tc+RP
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jmBrY-00063l-1B; Fri, 19 Jun 2020 07:55:00 +0000
Received: from mailgw02.mediatek.com ([216.200.240.185])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jmBrR-0005ze-QU
 for linux-mediatek@lists.infradead.org; Fri, 19 Jun 2020 07:54:56 +0000
X-UUID: 9fa81b02bbaa4472a9b4ef50ee9b48ff-20200618
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com;
 s=dk; 
 h=Content-Transfer-Encoding:Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From;
 bh=Do01dmbyCiGSjscxYJvy5ykc/vj3XzndARDxA1RPxtE=; 
 b=uzYBd9ESJ3HaYn9qmWNYROUp3/HpnexTGV9bYpFsCH9OliXwIA6993U5qEk+c46mKwV4u+aZFAcXsMTjPpSQIgOKXzhCCboxXt6MLOleS+pMdCZ0nQZ80Pnp1qEqZkT7+xJ6EJFKmIXArPGFdxdn7gtW9EA3QhUy+HHGEngp7Zc=;
X-UUID: 9fa81b02bbaa4472a9b4ef50ee9b48ff-20200618
Received: from mtkcas68.mediatek.inc [(172.29.94.19)] by mailgw02.mediatek.com
 (envelope-from <shayne.chen@mediatek.com>)
 (musrelay.mediatek.com ESMTP with TLS)
 with ESMTP id 2095826445; Thu, 18 Jun 2020 23:55:02 -0800
Received: from mtkmbs08n1.mediatek.inc (172.21.101.55) by
 MTKMBS62N2.mediatek.inc (172.29.193.42) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Fri, 19 Jun 2020 00:54:47 -0700
Received: from mtkcas07.mediatek.inc (172.21.101.84) by
 mtkmbs08n1.mediatek.inc (172.21.101.55) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Fri, 19 Jun 2020 15:54:46 +0800
Received: from mtksdccf07.mediatek.inc (172.21.84.99) by mtkcas07.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via
 Frontend Transport; Fri, 19 Jun 2020 15:54:47 +0800
...
X-CRM114-CacheID: sfid-20200619_005453_882450_CC572127 
...
---
 ...
 8 files changed, 69 insertions(+), 211 deletions(-)

diff --git a/drivers/net/wireless/mediatek/mt76/mt7915/debugfs.c b/drivers/net/wireless/mediatek/mt76/mt7915/debugfs.c
index 5278bee..6d4fd14 100644
--- a/drivers/net/wireless/mediatek/mt76/mt7915/debugfs.c
+++ b/drivers/net/wireless/mediatek/mt76/mt7915/debugfs.c
@@ -337,7 +337,7 @@ mt7915_read_rate_txpower(struct seq_file *s, void *data)
...
@@ -347,7 +347,7 @@ mt7915_read_rate_txpower(struct seq_file *s, void *data)
